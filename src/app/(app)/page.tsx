...
export default function Home() {
    return (
    <>
        <main className="flex-grow flex flex-col items-center justify-center px-4 md:px-24 py-28">
        ...
        <footer className="text-center w-full absolute bottom-0 p-4 md:p-6 bg-gray-900 text-white">
